...
* `3.0.90` Release - [3.0.900](#30900)
* `3.0.80` Release - [3.0.800](#30800)
* `3.0.70` Release - [3.0.700](#30700)
...
## 3.1.400
#### Changes
* `EMP-18870` Add missing params in `onDateRangeMetadataChanged`. New updated call back will be `.onDateRangeMetadataChanged { metadataGroups, indexesOfNewGroups, indexesOfModifiedGroups in .. }`
...
## 3.1.200
#### Changes
* `EMP-18778` Pass `CoreMediaErrorDomain` errors from  AVPlayerItemErrorLogEvent to the client. Client developers can track those erros in `player.onError`
...
## 3.1.000
#### Features
* `EMP-18532.` Add metadata collector to AVPlayerItem & Pass dateRangeMetada groups to the client. 
...
## 3.0.700
#### Bug Fixes
* `EMP-18485` Bug fix for airplay failure when changing playback on third party airplay devices ( ex : Samsung TV / LG TV ). `EMP-18434` Didn't fix the issue. 
...
## 3.0.500
#### Bug Fixes
* `EMP-18430`  Fix seekToTime in live streams


## 3.0.400
#### Bug Fixes
* `EMP-18319`  Fix broken Airplay 
